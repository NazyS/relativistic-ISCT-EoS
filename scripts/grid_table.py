...
if __name__ == "__main__":
    ...
    # grid range
    Trange = np.arange(100.0, 160.0, 10.0)
    murange = np.arange(300.0, 710.0, 10.0)
    ...
    for T in Trange:
        for mu in murange:
            ...
            data_dict["entropy"].append(eos.splined_entropy(T, mu, 0.0))
            data_dict["density"].append(eos.splined_density_baryon(T, mu, 0.0))
