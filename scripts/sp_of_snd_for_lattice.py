...
if __name__ == "__main__":
    ...
    print(
        "init for mu: {}\t g_M: {}\t g_B: {}\t m_M: {}\t m_B: {}".format(
            mu, g_M, g_B, m_M, m_B
        )
    )
    print("************************************************************")
    ...
    filepath = "rootdata_mixture_g_M_{}_g_B_{}_m_M_{}_m_B_{}_mu_{}_.csv".format(
        g_M, g_B, m_M, m_B, mu
    )
    ...
    Tdata = np.linspace(15.0, 3000.0, 100)
    pdata = []
    Sigmadata = []
    Kdata = []
    # entropydata = []
