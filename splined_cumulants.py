...
for dataname in ['exp_fo', 'matched']:
    ...
    for mu, T in zip(mu_data, T_data):
        ...
        k_lin_ratio.append(eos.splined_cumul_lin_ratio(T, mu, 0.))
        k_sq_ratio.append(eos.splined_cumul_sq_ratio(T, mu, 0.))
    ...
    filename = 'splined_cumul_data_{}_m_bos_{}_g_fer_{}_g_bos_{}_.csv'.format(dataname, m_bos, g_fer, g_bos)
